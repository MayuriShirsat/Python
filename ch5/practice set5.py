...
#     "plang":"bed"
# }
# word=input("Enter the world you want thr meaning of:")
# print(dictinary[word])

# Que2->program to input 8 no. from the user and display all the unnique no.
# language you like=set()
# m1=int(input("Enter the language you like:")) 
# language you like.add(m1)
# m2=int(input("Enter the language you like:"))
# language you like.add(m2)
# m3=int(input("Enter the language you like:"))
# language you like.add(m3)
# m4=int(input("Enter the language you like:"))
# language you like.add(m4)
# m5=int(input("Enter the language you like:"))
# language you like.add(m5)
# m6=int(input("Enter the language you like:"))
# language you like.add(m6)
# m7=int(input("Enter the language you like:"))
# language you like.add(m7)
# m8=int(input("Enter the language you like:"))
# language you like.add(m8)
# print(language you like)
